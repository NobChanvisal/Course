...
searchBox.addEventListener("keyup", (e) => {
  ...
  const filterPro = data.filter((pro) => 
    pro.names.toLowerCase().includes(searchItem) ||
      pro.category.toLowerCase().includes(searchItem) ||
      pro.brand.toLowerCase().includes(searchItem)
  );
  console.log(filterPro);
  display(filterPro.reverse())
});
