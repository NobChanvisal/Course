...
@section('content')
    ...
    <x-alert/>
    <form action="{{ route('categories.update', $category->id) }}" enctype="multipart/form-data" method="POST" class="w-full max-w-lg">
        @csrf
        @method('PUT')
        <div class="mb-4">
        ...
        <div>
            <label for="image">
                <img class=" cursor-pointer" width="100" src="{{asset('storage/'.$category->image)}}" alt="">
