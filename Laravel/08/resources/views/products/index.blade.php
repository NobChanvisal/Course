...
@section('content')
    ...
    <x-alert/>
        ...
        @else
                ...
                <tbody>
                    <tr>
                        <td colspan="9" class=" border px-4 py-2 text-center">
                            <a class=" text-blue-500" href="{{route('products.create')}}">add new</a>
                        </td>
                    </tr>
                    @foreach ($products as $pro)
                        <tr>
                            <td class=" border px-4 py-2">{{$pro->id}}</td>
                            <td class=" border px-4 py-2">{{$pro->name}}</td>
                            ...
                            <td class=" border px-4 py-2">{{$pro->status}}</td>
            ...
            {{-- <p class=" my-4">Total Products : <b>{{ $products->count() }}</b> </p> --}}
            {{-- pagination --}}
            <div class=" mt-5">
                {{ $products->links() }}
            </div>
